...
def probe_source() -> str:
    return textwrap.dedent(
        ...
        def target_shape(ref):
            ...
            list_like = sum(1 for line in lines if re.match(r"^\\s*(?:[-*•]|\\d+[.)]|[а-яa-z][.)])\\s+", line, flags=re.I))
        ...
        def feature_bucket(question):
            ...
            openish = "open" if re.search(r"(?:объясн|почему|опиши|essay|explain|describe)", q) else "closed"
