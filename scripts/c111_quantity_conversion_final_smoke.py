...
EXPERIMENT_ID = "C111"
EXPERIMENT_SLUG = "C111_quantity_conversion_final_smoke"
DEFAULT_OUT_DIR = Path("artifacts") / "tmp" / "C111_artifacts"
...
def write_report(report_path: Path, summary: dict[str, Any]) -> None:
    ...
    lines = [
        "# C111 Quantity Conversion Final Smoke Report",
        "",
        "## Objective",
        "- ID: C111",
        "- Mechanism: final-entrypoint smoke for C104 plus the C110 strict quantity-conversion solver.",
