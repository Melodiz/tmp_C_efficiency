...
EXPERIMENT_ID = "C218"
EXPERIMENT_SLUG = "C218_qwen3_4b_2507_fp8_paired_aggregate"
DEFAULT_OUT_DIR = Path("artifacts") / "tmp" / "C218_artifacts"
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="C218 paired Qwen3-8B-AWQ vs Qwen3-4B-2507-FP8 aggregate.")
    ...
    summary.update(
        {
            ...
            "reason": "Paired Qwen3-8B-AWQ vs Qwen3-4B-Instruct-2507-FP8 aggregate completed.",
            ...
            "variant_4b_2507_fp8": variant,
            "delta_4b_minus_8b": paired.overall_delta(variant, baseline),
...
def write_report(path: Path, summary: dict[str, Any]) -> None:
    lines = [
        "# C218 Qwen3-4B-Instruct-2507-FP8 Paired Aggregate",
        "",
        "## Result",
        ...
        "",
        "## Delta 4B Minus 8B",
        f"`{summary.get('delta_4b_minus_8b')}`",
        "",
        "## Delta By Category",
        ...
        "",
        "## Variant 4B",
        f"`{summary.get('variant_4b_2507_fp8')}`",
        "",
        "## Hygiene",
