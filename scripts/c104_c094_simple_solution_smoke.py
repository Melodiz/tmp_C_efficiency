...
EXPERIMENT_ID = "C104"
EXPERIMENT_SLUG = "C104_c094_simple_solution_smoke"
DEFAULT_OUT_DIR = Path("artifacts") / "tmp" / "C104_artifacts"
...
def write_report(report_path: Path, summary: dict[str, Any]) -> None:
    ...
    lines = [
        "# C104 C094 Simple-Solution Smoke Report",
        "",
        "## Objective",
        "- ID: C104",
        "- Mechanism: final-entrypoint smoke for C093 plus the C094 km/meters guard.",
